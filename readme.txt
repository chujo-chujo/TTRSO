...
Don't forget to check out parameters for additional options.
...
-> Use only one preset colour variant of buildings
   ...
   * The difference between these two options is sometimes arbitrary and depends only on the original author's choice of a recolour palette. That is why multi-coloured objects have a note indicating to which category they belong.
...
https://github.com/chujo-chujo/TTRSO
...
or www.tt-forums.net/viewtopic.php?t=91303
